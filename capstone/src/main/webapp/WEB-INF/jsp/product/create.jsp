...
<!-- Page Header -->
<section style="background-color: #343a40; color: white; padding: 1rem 0;">
    <div class="container">
...
<section style="background-color: #343a40; min-height: calc(100vh - 56px); display: flex; align-items: center; padding: 2rem 0;"> <!-- Added padding -->
    <div class="container">
                        ...
                        <form action="/product/createSubmit" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    ...
                                    <label for="option1">These radio buttons...</label>
                                </div>
                                <div>
                                    <input type="radio" id="option2" name="options" value="option2">
                                    <label for="option2">do not do anything.</label>
                                </div>
                                <div>
                                    <input type="radio" id="option3" name="options" value="option3">
                                    <label for="option3">It's for 1 point.</label>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="selectMenu" name="category" class="form-control">
                                    <option value="category1">A select menu</option>
                                    <option value="category2">in HTML</option>
                                    <option value="category3">for yet another 1 point.</option>
                                </select>
                            </div>
